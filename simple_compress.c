 ...
 * - Input data must have MSB = 0 (values < 128)
 * - Uses MSB = 1 to indicate a run: 0x80 | count
 * - Following 7 bits store the count (1-127)
 * - Compresses data in-place into the input array
 * 
